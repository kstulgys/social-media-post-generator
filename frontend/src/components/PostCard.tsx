...
// Helper function to render content with blue hashtags
function renderContentWithHashtags(text: string) {
  ...
  return parts.map((part, i) => {
    if (part.startsWith('#')) {
      return (
        <span key={i} className="text-blue-500 hover:text-blue-600 cursor-pointer">
          {part}
        </span>
      );
    }
...
export default function PostCard({ platform, content, index }: PostCardProps) {
  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow border border-gray-200">
      {/* Header */}
      ...
      <div className="bg-white p-4">
        ...
        <div className="flex items-center gap-3 mb-3">
          <div className={`w-10 h-10 rounded-full bg-gradient-to-br ${config.bgGradient} flex items-center justify-center text-white font-bold text-sm`}>
            YB
          </div>
          <div>
